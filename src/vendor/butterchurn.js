/* ────────────────────────────────────────────────────────────────────────────
 * VENDORED COPY of butterchurn (MilkDrop WebGL visualizer engine)
 *
 *   Source       : node_modules/butterchurn/lib/butterchurn.js
 *   Source repo  : https://github.com/jberg/butterchurn
 *   Version      : 2.6.7
 *   License      : MIT
 ...
 * and confirm our patches still apply.
 * ──────────────────────────────────────────────────────────────────────────── */
...
// (Original sourceMappingURL stripped — we didn't vendor the .js.map file.)

// ─── ESM bridge (added when this file was vendored) ──────────────────────────
// The UMD wrapper above runs as an IIFE on import. In a browser ESM context
// (Vite), it falls through to the `root["butterchurn"] = factory()` branch,
// which sets `window.butterchurn`. Re-export that as the ESM default so
// callers can use `import butterchurn from './vendor/butterchurn.js'` the
// same way they used `import butterchurn from 'butterchurn'`.
