...
| Multi-track | **Add-track Phase A shipped** (Full Screen layout): add/remove track, transparent gaps (empty upper track reveals beneath), top-row=front z-order, stacked tracks composite to the main/program output. `+ Add Track` in the transport row. Full detail + roadmap in [`add-track-dev.md`](add-track-dev.md). | 2026-05-24 |
