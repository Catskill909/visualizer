...
| Doc | Status | What it covers |
|-----|--------|---------------|
| [`tile-custom.md`](tile-custom.md) | ✅ Phase 2.5 shipped 2026-05-16 | Tiling enhancement plan — per-cell variance suite (Size/Jitter/Opacity Var + Seed), then scatter sampling: a neighbour-accumulation renderer that lets jittered tiles move freely past cell edges and overlap. Phase 3 (explicit grid + per-cell replicator editor) planned. |
