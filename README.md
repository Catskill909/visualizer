...
| Doc | Status | What it covers |
|-----|--------|---------------|
| [`tile-custom.md`](tile-custom.md) | ✅ Phase 3 shipped 2026-05-16 | Tiling enhancement plan — per-cell variance suite (Size/Jitter/Opacity Var + Seed), scatter sampling (neighbour-accumulation renderer — jittered tiles move freely + overlap), and explicit Grid mode (Density/Grid toggle, Cols×Rows, Fit/Fill, Grid Scale). Phases 3.2/3.3 (tunnel↔scatter convergence) and optional 3.5 (per-cell override editor) planned. |
